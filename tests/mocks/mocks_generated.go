...
import (
	...
	pipeline "github.com/mini-maxit/worker/internal/pipeline"
	...
	constants "github.com/mini-maxit/worker/pkg/constants"
...
func (m *MockResponder) PublishPayloadTaskRespond(messageType, messageID, responseQueue string, taskResult solution.Result) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "PublishPayloadTaskRespond", messageType, messageID, responseQueue, taskResult)
}
...
func (m *MockResponder) PublishSuccessHandshakeRespond(messageType, messageID, responseQueue string, languageSpecs messages.ResponseHandshakePayload) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "PublishSuccessHandshakeRespond", messageType, messageID, responseQueue, languageSpecs)
}
...
func (m *MockResponder) PublishSuccessStatusRespond(messageType, messageID, responseQueue string, status messages.ResponseWorkerStatusPayload) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "PublishSuccessStatusRespond", messageType, messageID, responseQueue, status)
}
...
// PublishTaskErrorToResponseQueue mocks base method.
func (m *MockResponder) PublishTaskErrorToResponseQueue(messageType, messageID, responseQueue string, err error) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "PublishTaskErrorToResponseQueue", messageType, messageID, responseQueue, err)
}

// PublishTaskErrorToResponseQueue indicates an expected call of PublishTaskErrorToResponseQueue.
func (mr *MockResponderMockRecorder) PublishTaskErrorToResponseQueue(messageType, messageID, responseQueue, err any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PublishTaskErrorToResponseQueue", reflect.TypeOf((*MockResponder)(nil).PublishTaskErrorToResponseQueue), messageType, messageID, responseQueue, err)
}
...
func (m *MockPackager) SendSolutionPackage(dirConfig *packager.TaskDirConfig, testCases []messages.TestCase, hasCompilationErr bool, msgID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendSolutionPackage", dirConfig, testCases, hasCompilationErr, msgID)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendSolutionPackage indicates an expected call of SendSolutionPackage.
func (mr *MockPackagerMockRecorder) SendSolutionPackage(dirConfig, testCases, hasCompilationErr, msgID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendSolutionPackage", reflect.TypeOf((*MockPackager)(nil).SendSolutionPackage), dirConfig, testCases, hasCompilationErr, msgID)
}
...
func (m *MockVerifier) EvaluateAllTestCases(dirConfig *packager.TaskDirConfig, testCases []messages.TestCase, messageID string, langType languages.LanguageType) solution.Result {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EvaluateAllTestCases", dirConfig, testCases, messageID, langType)
	ret0, _ := ret[0].(solution.Result)
	return ret0
}

// EvaluateAllTestCases indicates an expected call of EvaluateAllTestCases.
func (mr *MockVerifierMockRecorder) EvaluateAllTestCases(dirConfig, testCases, messageID, langType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EvaluateAllTestCases", reflect.TypeOf((*MockVerifier)(nil).EvaluateAllTestCases), dirConfig, testCases, messageID, langType)
}
...
// Code generated by MockGen. DO NOT EDIT.
// Source: /Users/mateuszosik/repos/Testerka/worker/internal/pipeline (interfaces: Worker)
//
// Generated by this command:
//
//	mockgen /Users/mateuszosik/repos/Testerka/worker/internal/pipeline Worker
//
...
func (mr *MockWorkerMockRecorder) GetId() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetId", reflect.TypeOf((*MockWorker)(nil).GetId))
}

// GetProcessingMessageID mocks base method.
func (m *MockWorker) GetProcessingMessageID() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetProcessingMessageID")
	ret0, _ := ret[0].(string)
	return ret0
}

// GetProcessingMessageID indicates an expected call of GetProcessingMessageID.
func (mr *MockWorkerMockRecorder) GetProcessingMessageID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetProcessingMessageID", reflect.TypeOf((*MockWorker)(nil).GetProcessingMessageID))
}

// GetState mocks base method.
func (m *MockWorker) GetState() pipeline.WorkerState {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetState")
	ret0, _ := ret[0].(pipeline.WorkerState)
	return ret0
}

// GetState indicates an expected call of GetState.
func (mr *MockWorkerMockRecorder) GetState() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetState", reflect.TypeOf((*MockWorker)(nil).GetState))
}

// ProcessTask mocks base method.
func (m *MockWorker) ProcessTask(messageID, responseQueue string, task *messages.TaskQueueMessage) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ProcessTask", messageID, responseQueue, task)
}

// ProcessTask indicates an expected call of ProcessTask.
func (mr *MockWorkerMockRecorder) ProcessTask(messageID, responseQueue, task any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProcessTask", reflect.TypeOf((*MockWorker)(nil).ProcessTask), messageID, responseQueue, task)
}

// UpdateStatus mocks base method.
func (m *MockWorker) UpdateStatus(status constants.WorkerStatus) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "UpdateStatus", status)
}

// UpdateStatus indicates an expected call of UpdateStatus.
func (mr *MockWorkerMockRecorder) UpdateStatus(status any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateStatus", reflect.TypeOf((*MockWorker)(nil).UpdateStatus), status)
}

// Code generated by MockGen. DO NOT EDIT.
// Source: /Users/mateuszosik/repos/Testerka/worker/internal/docker (interfaces: DockerClient)
//
// Generated by this command:
//
//	mockgen /Users/mateuszosik/repos/Testerka/worker/internal/docker DockerClient
//
...
func (m *MockDockerClient) ContainerKill(ctx context.Context, containerID, signal string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ContainerKill", ctx, containerID, signal)
}
...
func (m *MockDockerClient) ContainerRemove(ctx context.Context, containerID string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ContainerRemove", ctx, containerID)
}
...
func (m *MockDockerClient) CopyFromContainerFiltered(ctx context.Context, containerID, srcPath, dstPath string, allowedDirs, alwaysCopyFiles []string, maxFileSize int64, maxFilesInDir int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CopyFromContainerFiltered", ctx, containerID, srcPath, dstPath, allowedDirs, alwaysCopyFiles, maxFileSize, maxFilesInDir)
	ret0, _ := ret[0].(error)
	return ret0
}

// CopyFromContainerFiltered indicates an expected call of CopyFromContainerFiltered.
func (mr *MockDockerClientMockRecorder) CopyFromContainerFiltered(ctx, containerID, srcPath, dstPath, allowedDirs, alwaysCopyFiles, maxFileSize, maxFilesInDir any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CopyFromContainerFiltered", reflect.TypeOf((*MockDockerClient)(nil).CopyFromContainerFiltered), ctx, containerID, srcPath, dstPath, allowedDirs, alwaysCopyFiles, maxFileSize, maxFilesInDir)
}
...
func (m *MockDockerClient) EnsureImage(ctx context.Context, imageName string) error {
	m.ctrl.T.Helper()
...
func (mr *MockDockerClientMockRecorder) EnsureImage(ctx, imageName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnsureImage", reflect.TypeOf((*MockDockerClient)(nil).EnsureImage), ctx, imageName)
}
...
func (m *MockDockerClient) WaitContainer(ctx context.Context, containerID string, timeout time.Duration) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WaitContainer", ctx, containerID, timeout)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDockerClientMockRecorder) WaitContainer(ctx, containerID, timeout any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WaitContainer", reflect.TypeOf((*MockDockerClient)(nil).WaitContainer), ctx, containerID, timeout)
}

// Code generated by MockGen. DO NOT EDIT.
// Source: /Users/mateuszosik/repos/Testerka/worker/internal/storage (interfaces: FileCache)
//
// Generated by this command:
//
//	mockgen /Users/mateuszosik/repos/Testerka/worker/internal/storage FileCache
//
...
func (m *MockFileCache) CleanExpiredCache() error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CleanExpiredCache")
	ret0, _ := ret[0].(error)
	return ret0
}

// CleanExpiredCache indicates an expected call of CleanExpiredCache.
func (mr *MockFileCacheMockRecorder) CleanExpiredCache() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CleanExpiredCache", reflect.TypeOf((*MockFileCache)(nil).CleanExpiredCache))
}
...
func (m *MockFileCache) InitCache() error {
	m.ctrl.T.Helper()
...
func (mr *MockFileCacheMockRecorder) InitCache() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InitCache", reflect.TypeOf((*MockFileCache)(nil).InitCache))
}
