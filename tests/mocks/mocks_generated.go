...
func (m *MockResponder) PublishTaskErrorToResponseQueue(messageType, messageID, responseQueue string, err error) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PublishTaskErrorToResponseQueue", messageType, messageID, responseQueue, err)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockDockerClientMockRecorder) WaitContainer(ctx, containerID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WaitContainer", reflect.TypeOf((*MockDockerClient)(nil).WaitContainer), ctx, containerID)
}
